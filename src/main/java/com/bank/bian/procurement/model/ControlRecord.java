package com.bank.bian.procurement.model;
...
/**
 * The BIAN control record for this service domain: "Purchase Order Procedure".
 *
 ...
 * to its asset type (Purchase Order). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Purchase Order Procedure";
